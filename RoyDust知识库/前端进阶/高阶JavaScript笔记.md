...
![image-20220828003751970](C:/Users/Roy_Dust/AppData/Roaming/Typora/typora-user-images/image-20220828003751970.png)
...
console.log(sa === sb);	// ture

const key = Symbol.keyFor(sa);
console.log(key);	// abc
const sc = Symbol.for(key);
console.log(sa === sc); // ture
```
...
Object.create(prototype, descriptors) 以指定 的 **原型创建对象，并且可以（可选） 的 设置对象 的属性** Object.defineProperty(object, propertyname, descriptor) 对指定 的 对象 的 一个属性设置丰富的值控制 
...
![image-20220910003743283](lyc-markdownimg.test.upcdn.net/img/202209100213699.png)
...
![image-20220910005035278](lyc-markdownimg.test.upcdn.net/img/202209100213900.png)
...
![image-20220910010352190](lyc-markdownimg.test.upcdn.net/img/202209100213716.png)
...
![image-20220910010506596](lyc-markdownimg.test.upcdn.net/img/202209100213683.png)
...
![image-20220910011205066](lyc-markdownimg.test.upcdn.net/img/202209100213456.png)
